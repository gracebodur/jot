        ...
        this.$notes.innerHTML = this.notes
            ...
            <div style='background: ${note.color};' class='note' data-id='${note.id}'>
                ...
                <div class='toolbar-container'>
                    <div class='toolbar'>
                        <img class='toolbar-color' data-id=${note.id} src='./assets/paint.svg' alt='color options' width="640" height="360">
                        <img class='toolbar-delete' data-id=${note.id} src='./assets/delete.svg' alt='delete icon' width="640" height="360">
                    </div>
                </div>
            </div>
        ` )
